...
export default function FloatingContact() {
  return (
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-3 flex gap-3 z-[60] shadow-[0_-4px_10px_-2px_rgba(0,0,0,0.1)]">
        <a 
          href="tel:+919331488999" 
          className="flex-1 flex items-center justify-center gap-2 border-2 border-slate-900 text-slate-900 font-bold py-3 rounded-xl bg-white hover:bg-slate-50 transition-colors"
        >
        ...
        <a 
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-[#128C7E] text-white font-bold py-3 rounded-xl hover:bg-[#0c6b5f] transition-colors"
        >
