...
export default function ContactPage() {
  ...
  const contacts = [
    ...
    { icon: Phone, label: 'Phone', value: '6291957542', note: 'Available during business hours', href: 'tel:+916291957542', color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-200' },
            ...
            <div className="max-w-2xl lg:pt-16 lg:pb-56 xl:pl-12 flex flex-col justify-start">
              <div>
                ...
                <p className="text-lg text-slate-500 mb-8 max-w-lg leading-relaxed font-medium">
                  Have a question, a workforce requirement, or need help getting started? Reach out to us.
                </p>
              </div>
            </div>
