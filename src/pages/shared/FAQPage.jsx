...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Are the worker numbers verified and safe?', a: "Every worker completes Aadhaar-based KYC verification, skill assessment, and customer OTP job validation before their contact details appear in the Direct Connect pool. Your transaction is also secured by Cashfree PG." },
